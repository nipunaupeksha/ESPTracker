 ...
 * @author Nipuna
 */
public class SelectedMapExtendedMapLinesPre extends javax.swing.JFrame {
    ...
    private int minimumValIndex[] = new int[4];
    ...
    public SelectedMapExtendedMapLinesPre() {
        initComponents();
    ...
    private void posSelector() {
        if (((convertValues[arr1[0]] == convertValues[arr1[1]]||convertValues[arr1[0]] == convertValues[arr1[1]]+5||convertValues[arr1[0]] == convertValues[arr1[1]]-5) 
                && (convertValues[arr1[1]] == convertValues[arr1[2]]||convertValues[arr1[1]] == convertValues[arr1[2]]+5||convertValues[arr1[1]] == convertValues[arr1[2]]-5)
                && (convertValues[arr1[2]] == convertValues[arr1[3]]||convertValues[arr1[2]] == convertValues[arr1[3]]+5||convertValues[arr1[2]] == convertValues[arr1[3]]-5) 
                && (convertValues[arr1[3]] == convertValues[arr1[0]]||convertValues[arr1[3]] == convertValues[arr1[0]]+5||convertValues[arr1[3]] == convertValues[arr1[0]]-5)) && sumIndex == 1) {
            posX = diagonalMap_2[0][0];
            posY = diagonalMap_2[0][1];
        } else if (((convertValues[arr2[0]] == convertValues[arr2[1]]||convertValues[arr2[0]] == convertValues[arr2[1]]+5||convertValues[arr2[0]] == convertValues[arr2[1]]-5) 
                && (convertValues[arr2[1]] == convertValues[arr2[2]]||convertValues[arr2[1]] == convertValues[arr2[2]]+5||convertValues[arr2[1]] == convertValues[arr2[2]]-5)
                && (convertValues[arr2[2]] == convertValues[arr2[3]]||convertValues[arr2[2]] == convertValues[arr2[3]]+5||convertValues[arr2[2]] == convertValues[arr2[3]]-5) 
                && (convertValues[arr2[3]] == convertValues[arr2[0]]||convertValues[arr2[3]] == convertValues[arr2[0]]+5||convertValues[arr2[3]] == convertValues[arr2[0]]-5)) && sumIndex == 2) {
            posX = diagonalMap_2[1][0];
            posY = diagonalMap_2[1][1];
        } else if (((convertValues[arr3[0]] == convertValues[arr3[1]]||convertValues[arr3[0]] == convertValues[arr3[1]]+5||convertValues[arr3[0]] == convertValues[arr3[1]]-5) 
                && (convertValues[arr3[1]] == convertValues[arr3[2]]||convertValues[arr3[1]] == convertValues[arr3[2]]+5||convertValues[arr3[1]] == convertValues[arr3[2]]-5)
                && (convertValues[arr3[2]] == convertValues[arr3[3]]||convertValues[arr3[2]] == convertValues[arr3[3]]+5||convertValues[arr3[2]] == convertValues[arr3[3]]-5) 
                && (convertValues[arr3[3]] == convertValues[arr3[0]]||convertValues[arr3[3]] == convertValues[arr3[0]]+5||convertValues[arr3[3]] == convertValues[arr3[0]]-5)) && sumIndex == 3) {
            posX = diagonalMap_2[2][0];
            posY = diagonalMap_2[2][1];
        } else if (((convertValues[arr4[0]] == convertValues[arr4[1]]||convertValues[arr4[0]] == convertValues[arr4[1]]+5||convertValues[arr4[0]] == convertValues[arr4[1]]-5) 
                && (convertValues[arr4[1]] == convertValues[arr4[2]]||convertValues[arr4[1]] == convertValues[arr4[2]]+5||convertValues[arr4[1]] == convertValues[arr4[2]]-5)
                && (convertValues[arr4[2]] == convertValues[arr4[3]]||convertValues[arr4[2]] == convertValues[arr4[3]]+5||convertValues[arr4[2]] == convertValues[arr4[3]]-5) 
                && (convertValues[arr4[3]] == convertValues[arr4[0]]||convertValues[arr4[3]] == convertValues[arr4[0]]+5||convertValues[arr4[3]] == convertValues[arr4[0]]-5)) && sumIndex == 4) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SelectedMapExtendedMapLinesPre.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SelectedMapExtendedMapLinesPre().setVisible(true);
            }
        });
    }
