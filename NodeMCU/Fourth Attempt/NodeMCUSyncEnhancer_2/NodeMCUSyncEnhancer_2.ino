...
const char* ssid="WiFi-Router";/*"Nipuna-WiFi";*//*"Thinuli";*/
const char* password="T0JENMTJ7N2";/*"168noctis";*//*"ck0713425680";*/
...
void javascriptContent(){
    ...
    Javascript+="setTimeout(function(){location.reload();},1000);\n"; //'process()'
    Javascript+="}\n";
    Javascript+="</SCRIPT>\n";
  }
...
//  
   ...
   // Serial.println(data);
    /*if(data.indexOf('B')>0){
      ...
      while(millis()<(tN+2.5*1000)){}
      break;
      }*/
    }
    /*
while(data.indexOf('B')<0){
  Serial.println("Deep Sleep 0.1");
  ESP.deepSleep(0.1*1e6);
}*/
